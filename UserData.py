...
#this function creates a connection to SQLLite database
...
def createTable():
#this function creates a table named Userdetails to store user,email and lastLogin details 
...
#response is inserted into the database
